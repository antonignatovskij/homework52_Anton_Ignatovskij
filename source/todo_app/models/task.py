...
class TodoItem(models.Model):
    ...
    status = models.ForeignKey('todo_app.Status', related_name="task", on_delete=models.RESTRICT, null=False,
                               blank=False, verbose_name="Статус")
    ...
    project = models.ForeignKey('todo_app.Project', related_name="task", on_delete=models.CASCADE, null=False,
